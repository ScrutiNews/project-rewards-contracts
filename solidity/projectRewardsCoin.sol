...
contract ProjectRewardsCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function ProjectRewardsCoin() {
        ...
        name = "ProjectRewardsCoin";                                 // Set the name for display purposes (CHANGE THIS)
